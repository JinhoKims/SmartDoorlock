        ...
        mBluetoothHandler = new Handler(){
            public void handleMessage(android.os.Message msg){
                if(msg.what == BT_MESSAGE_READ) {
                    ...
                    btn_bell.setBackgroundResource((readMessage.charAt(0) - '0' == 3) ? R.drawable.bell_pressed : R.drawable.bell_default); // 벨
                    btn_person.setBackgroundResource((readMessage.charAt(1) - '0' == 5) ? R.drawable.door_person_yes : R.drawable.door_person_default); // 조도
                    ...
                    btn_temperature.setBackgroundResource((readMessage.charAt(3) - '0' == 4) ? R.drawable.temperature_hot : R.drawable.temperature_default); // 온도
                    ...
                    if (readMessage.charAt(0) - '0' > 0 && sendMarker) {
                        ...
                        temperatureRef.push().setValue(infoData); // 데이터 전송
